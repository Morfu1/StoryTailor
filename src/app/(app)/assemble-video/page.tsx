...
// New component for the "Edit Timeline Item" panel content
function EditTimelineItemPanelContent({
  storyData,
...
export default function AssembleVideoPage() {
  ...
  // Helper function to extract entity descriptions from prompts, moved to component scope
  ...
  const handleEditGenerate = async () => {
    ...
    try {
      ...
      const expandedPrompt = parseEntityReferences(editedPrompt);
